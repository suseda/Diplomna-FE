...
function View_recipe_page() {
  ...
  const handleLike = async () => {
    let likes: number;
    if (isLiked) likes = recipeLikes - 1;
    else likes = recipeLikes + 1;
          ...
          <div className="grid grid-rows-1 grid-cols-2 gap-4">
            ...
            <div className="grid-cols-2 grid-flow-col gap-4 flex items-center justify-center">
              <div className="card w-96 bg-base-100 shadow-xl">
                <figure className="rounded-md"><img src={"data:image/jpeg;base64," + recipe.photoText} alt="Recipe photo" /></figure>
              </div>
            </div>
          </div>
